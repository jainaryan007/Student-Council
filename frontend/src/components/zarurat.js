...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-8">
      ...
      Giving wings to dreams that deserve to soar. Zarurat is a social club that aims to empower every child with the education they aspire to and build a brighter future.
      </p>
