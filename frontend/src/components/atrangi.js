...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-20">
      ...
      Atrangi is a cultural club that is a vibrant hub of art and artists, brimming with creativity in every form. From poets to writers and beyond, there is no limit to the imagination that thrives here.
      </p>
