...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-8">
      {/* Logo */}
      <div className="mb-4">
        <img
          src="img/clubs/suhasini.webp"
          alt="Logo"
      ...
      Suhasni is a social club at JECRC dedicated to empowering girls through education, ensuring their safety, and fostering their dreams for each one to rise and shine with confidence and courage.
      </p>
