...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-8">
      ...
      FnF, the drama club, allows students to participate in acting and stage performances, bringing stories to life at JECRC. For what we know, they're a bunch of overachievers.
      </p>
