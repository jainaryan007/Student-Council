...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-8 mt-16">
      {/* Logo */}
      <div className="mb-4">
        <img
          src="img/clubs/avyaan.webp"
          alt="Logo"
          className="w-60 h-60 md:w-48 md:h-48 object-cover"
        />
      </div>
      ...
      Where voices blend and magic happens—Avyaan, the music club of JECRC. A stage for dreamers, creators, and performers to shine. Every note sparks a new story, turning silence into symphony!
      </p>
