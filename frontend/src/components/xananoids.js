...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-16">
      ...
      Where innovation meets automation. Crafting robots that redefine possibilities and spark future revolutions, engineered by passionate minds dedicated to pushing the boundaries of technology.
      </p>
