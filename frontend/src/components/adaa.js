...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-8">
      ...
      Where fashion isn't just worn, it's lived with confidence and creativity. Elegance in every edge, boldness in every fold—Adaa sets the trend.
      </p>
