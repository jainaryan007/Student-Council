...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-16">
      ...
      SOCH KUCH KAR DIKHANE KI”. From 'Safai Abhiyan' to 'Vastr Samman', SOCH makes a difference through environmental cleanups, clothing drives, and social awareness campaigns.
      </p>
