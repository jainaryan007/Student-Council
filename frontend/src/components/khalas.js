...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-20">
      ...
      Khalas is the Bhangra club of JECRC which celebrates the Punjabi culture through traditional and energetic dance performances.
      </p>
