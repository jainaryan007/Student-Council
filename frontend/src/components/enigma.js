...
const CenteredLogoSection = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 mt-20">
      ...
      Dancing to the rhythm of life—Enigma, where passion takes form. A space where creativity flows with every beat and emotion finds its expression through movement.
      </p>
